...
<div class="checkout-container">
    <div class="checkout-header">
        <h1>Checkout</h1>
        <p>Complete your purchase to start listing your stadiums</p>
    </div>
    ...
    <div class="checkout-grid">
        ...
        <div class="checkout-form-section">
            ...
            <?php if($data['is_logged_in']): ?>
                ...
                <div class="info-message">
                    📋 After purchase, "Stadium Owner" role will be added to your account and you'll be able to access the Stadium Owner Dashboard.
                </div>
            ...
            <?php else: ?>
                ...
                <div id="login-tab" class="tab-content active">
                    <form method="POST" action="<?php echo URLROOT; ?>/login">
                        <input type="hidden" name="redirect_to" value="<?php echo URLROOT; ?>/pricing/checkout/<?php echo strtolower($data['package']->name); ?>">
                ...
                <div id="register-tab" class="tab-content">
                    <div class="info-message">
                        ℹ️ You'll create a Stadium Owner account. You can add other roles later if needed.
                    </div>

                    <form method="POST" action="<?php echo URLROOT; ?>/register/stadium_owner">
                        <input type="hidden" name="redirect_to" value="<?php echo URLROOT; ?>/pricing/checkout/<?php echo strtolower($data['package']->name); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="business-name" class="form-input" placeholder="Your Stadium Name" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="venue-type" class="form-input" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="business-reg" class="form-input" placeholder="BR123456789" required>
                        </div>
        ...
        <div class="order-summary">
            ...
            <div class="package-summary">
                <div class="package-summary-header">
                    ...
                    <div class="package-summary-details">
                        <h3><?php echo htmlspecialchars($data['package']->name); ?> Plan</h3>
                        <p><?php echo htmlspecialchars($data['package']->description); ?></p>
                    </div>
                </div>
                ...
                <div class="summary-features">
                    ...
                    <ul>
                        <li><?php echo $data['package']->features->stadium_limit === 'unlimited' ? 'Unlimited' : $data['package']->features->stadium_limit; ?> Stadium Listings</li>
                        <li><?php echo $data['package']->features->photos_per_property; ?> Photos per Stadium</li>
                        <li><?php echo $data['package']->features->videos_per_property; ?> Videos per Stadium</li>
                        <li><?php echo $data['package']->commission; ?>% Commission per Booking</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="price-breakdown">
                <div class="price-row">
                    <span>Setup Fee:</span>
                    <span>LKR <?php echo number_format($data['package']->setup_fee); ?></span>
                </div>
                <div class="price-row">
                    <span>Commission:</span>
                    <span><?php echo $data['package']->commission; ?>% per booking</span>
                </div>
