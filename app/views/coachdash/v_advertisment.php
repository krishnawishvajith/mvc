...
<div class="kal-coach-dashboard-advertisement">
    ...
    <div class="kal-coach-dashboard-advertisement-card" style="margin-bottom:30px;">
        <div class="kal-coach-dashboard-advertisement-card-header">
            <h3>📢 Submit New Advertisement</h3>
        </div>
        <div style="padding:20px;">
            <p style="color:#666;margin-bottom:20px;">Promote your coaching services, training programs, or sports business to our community</p>

            <form action="<?php echo URLROOT; ?>/coachdash/submitAdvertisement" method="POST" enctype="multipart/form-data">
            ...
            <div style="padding:20px;display:grid;grid-template-columns:repeat(auto-fill, minmax(300px, 1fr));gap:20px;">
                ...
                <div class="ad-card" style="border:1px solid #e0e0e0;border-radius:12px;overflow:hidden;">
                    ...
                    <div style="padding:10px 15px;background:#f8f9fa;display:flex;gap:10px;border-top:1px solid #e0e0e0;">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo URLROOT; ?>/coachdash/deleteAdvertisement/<?php echo $ad->id; ?>" 
...
function openEditModal(id, companyName, website, message) {
    document.getElementById('editForm').action = '<?php echo URLROOT; ?>/coachdash/editAdvertisement/' + id;
